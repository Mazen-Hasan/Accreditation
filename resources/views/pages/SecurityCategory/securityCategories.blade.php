...
{{--        <a href="{{route('eventAdd')}}" class="btn btn-info ml-3" id="add-new-Title">Add New Evant</a>--}}
        <a href="javascript:void(0)" class="btn btn-info ml-3" id="add-new-post">Add New Security Category</a>
        <br><br>
        <div class="row">
                ...
                <div class="modal-body">
                    <form id="postForm" name="postForm" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="name" class="col-sm-2 control-label">Security Category</label>
                            <div class="col-sm-12">
